...
contract GovernorAlpha {
    ...
    string public constant name = "SpiralX Governor Alpha";
    ...
    /// @notice The address of the SpiralX Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the SpiralX governance token
    ...
    function getActions(uint256 proposalId) external view returns (address[] memory targets, uint256[] memory values, string[] memory signatures,
            bytes[] memory calldatas){
