    ...
    ExponentialNoError
{
    ...
    /// @notice Emitted when SPX is distributed to a borrower
    ...
    /// @notice Emitted when SPX is granted by admin
        ...
        )
    {
        ...
        for (uint256 i = 0; i < assets.length; i++) {
            ...
            vars.tokensToDenom = mulExp3(vars.collateralFactor, vars.exchangeRate, vars.oraclePrice);
    ...
    /**
     * @notice Accrue Compound to the market by updating the supply index
    ...
    /**
     * @notice Accrue Compound to the market by updating the borrow index
    ...
    /**
     * @notice Calculate Compound accrued by a supplier and possibly transfer it to them
     * @param cToken The market in which the supplier is interacting
     * @param supplier The address of the supplier to distribute Compound to
     */
    ...
    /**
     * @notice Calculate Compound accrued by a borrower and possibly transfer it to them
     * @dev Borrowers will not begin to accrue until after the first interaction with the protocol.
     * @param cToken The market in which the borrower is interacting
     * @param borrower The address of the borrower to distribute Compound to
     */
     ...
     * @param userAccrued The amount of Compound to (possibly) transfer
    ...
    /**
     * @notice Claim all the Compound accrued by holder in the specified markets
     * @param holder The address to claim Compound for
     * @param cTokens The list of markets to claim Compound in
     */
    ...
    /**
     * @notice Claim all Compound accrued by the holders
     * @param holders The addresses to claim Compound for
     * @param cTokens The list of markets to claim Compound in
     * @param borrowers Whether or not to claim Compound earned by borrowing
     * @param suppliers Whether or not to claim Compound earned by supplying
     */
    function claimComp(
    ...
    /**
     * @notice Return the address of the SPX token
